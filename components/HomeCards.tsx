...
const cards = [
  {
    ...
    link: '/erase',
    image: '/file.svg', // Use your eraser image here, e.g. '/eraser.png' if you have it
    bg: styles.cardBlue,
  ...
  return (
    <div className={styles.homeGrid}>
      <div className={styles.topRow}>
        {cards.map((card) => (
          <div className={`${styles.cardBtn} ${card.bg}`} key={card.title}>
            ...
            <Link href={card.link} className={styles.cardLink} aria-label={card.title} />
          </div>
        ))}
      </div>
    </div>
